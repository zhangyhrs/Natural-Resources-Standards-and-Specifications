...
<p align="center">
  <img src="https://img.shields.io/badge/技术标准-多层级资料-2F6B3B" alt="技术标准">
...
本仓库用于集中整理自然资源领域常用的**技术标准、规范规程、法律法规、部门规章、规范性文件及政策文件**，便于日常学习、项目实施和资料查阅。技术资料以自然资源部2022年《自然资源标准体系》作为主要组织框架，同时兼顾相关国家标准、行业标准、地方标准、团体标准、企业标准及其他参考资料；法律法规按照“**法律效力层级 → 业务领域或地区**”分类，资料后续持续补充更新。

| 资料类型 | 组织方式 | 快速入口 |
|---|---|---|
| **技术标准规范** | 标准体系 + 标准层级 + 资料状态 | [技术标准检索](https://zhangyhrs.github.io/Natural-Resources-Standards-and-Specifications/) · [标准目录](./标准目录.md) |
| **法律法规** | 法律效力层级 → 业务领域或地区 | [法律法规检索](https://zhangyhrs.github.io/Natural-Resources-Standards-and-Specifications/laws.html) · [法律法规目录](./法律法规索引.md) |
| **常用资料** | 高频标准和常用业务资料 | [常用资料速查](./常用资料速查.md) |
| **全部资料** | 总索引与自动文件清单 | [总索引](./总索引.md) |

## 🔎 在线检索

技术标准检索页支持按**标准名称、标准号、标准层级、标准性质、资料状态、标准体系和专业分类**筛选，并可直接下载仓库已收录文档。

标准层级除国家标准、行业标准外，也支持**地方标准、团体标准、企业标准、其他标准及未识别资料**。对于没有标准号或尚未正式发布的资料，不再直接排除，而是通过“资料状态”区分为**编号标准、征求意见稿、草案、送审稿、报批稿、试行、暂行、无编号资料**等，避免将非正式资料误当作现行正式标准。
...
标准体系用于业务分类，标准层级和资料状态作为辅助属性，不要求所有资料都必须具有正式标准号。
...
本仓库主要用于技术学习、资料索引和行业资料整理。各标准、规范、法律法规及相关文件的著作权和传播权归原发布机构或权利人所有；检索页中的分类和资料状态主要用于仓库内部管理，不作为标准现行有效性的判定依据，具体法律效力、标准状态和适用范围应以官方发布信息为准。
